<%-- 
    ...
    Created on : 26/01/2018, 17:28:54
    Author     : Matheus
--%>
   ...
   <div class="container">     
    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <form name="form" method="post" action="CadastroCliente" class="form-signin">
            <div class="row">  
            <div class="col-sm-8">
          ...
          <div class="row">  
            <div class="col-sm-8">
                ...
                <input type="text" name ="cpf" class="form-control" id="cpf"placeholder="ex: 123456789"required/>
             </div>   
          </div>  
            <br>
